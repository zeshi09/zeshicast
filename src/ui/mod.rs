...
pub use views::{
    ...
    ai_chat_view, audio_view, clipboard_history_view, dashboard_view, extension_browser_view,
    media_view, network_view, notifications_view, preferences_view, script_output_view,
