...
pub use views::{
    ...
    DashboardView, EmojiPickerView, ExtensionBrowserView, MediaView, NetworkView, NotificationsView,
    PreferencesView, ScriptOutputView, SnippetManagerView, SystemMonitorView, action_panel_view,
    ai_chat_view, audio_view, clipboard_history_view, dashboard_view, emoji_picker_view,
    extension_browser_view, media_view, network_view, notifications_view, preferences_view,
    script_output_view, set_action_panel_items, set_action_panel_list, set_audio_snapshot,
    set_clipboard_detail, set_clipboard_history_items, set_dashboard_audio_snapshot,
    set_dashboard_battery_snapshot, set_dashboard_media_snapshot, set_dashboard_network_snapshot,
    ...
    snippet_manager_view, system_monitor_view,
};
pub use widgets::{
