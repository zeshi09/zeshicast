...
pub use views::{
    ...
    DashboardView, ExtensionBrowserView, MediaView, NetworkView, NotificationsView,
    PreferencesView, SnippetManagerView, SystemMonitorView, action_panel_view, ai_chat_view,
    audio_view, clipboard_history_view, dashboard_view, extension_browser_view, media_view,
    network_view, notifications_view, preferences_view, set_action_panel_items,
    ...
    set_media_snapshot, set_network_snapshot, set_notification_snapshot, set_snippet_items,
